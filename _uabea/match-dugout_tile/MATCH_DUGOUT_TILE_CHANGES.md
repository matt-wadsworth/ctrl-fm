...
| Dugout 4×8 inline style  | 4355907201153990605 (`inlineStyle`) | Rule index **6**           | Add a **new style rule at index 6**: `background-color` **#060D17FA**, `border-radius`, `border-width`, `border-color` (e.g. radius **12**, width **1**, light border on `vector colors` index **1**). |
