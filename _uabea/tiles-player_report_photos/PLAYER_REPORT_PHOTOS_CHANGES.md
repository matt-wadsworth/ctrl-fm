...
- After a title update, re-export the bundle, locate the same **`inlineStyle`** assets (match **Path ID** and CAB segment in the filename if names shift), and re-apply the **dimensions** / **colors** edits below.
